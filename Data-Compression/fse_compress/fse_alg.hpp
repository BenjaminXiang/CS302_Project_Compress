...
private:
    ...
    int* NormalizeCount(const unsigned char *data, int data_size, int *freqs, int num_symbols, int PROBABILITY_PRECISION) {
    ...
    vector<vector<int> > CreateEncodingTable(const int *freqs, int num_symbols, int PROBABILITY_PRECISION, int MAX_STATE) {
...
public:
    ...
    bool Compress(const unsigned char *data, int data_size, int num_symbols, vector<unsigned char>& encoded_stream,
                    int *freqs, int& byte_offset, int& final_state) {
        ...
        freqs = NormalizeCount(data, data_size, freqs, num_symbols, PROBABILITY_PRECISION);
    ...
    void Decompress(const unsigned char *encoded_stream, const int encoded_size, const int *freqs, vector<unsigned char>& decoded_stream,
